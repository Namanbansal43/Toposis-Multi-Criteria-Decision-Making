...
### PyPI Link
🔗 [https://pypi.org/project/Topsis-Naman-102303496/](https://pypi.org/project/Topsis-Naman-102303496/)
...
### 👉 Streamlit App Link:
🔗 [https://topsis-streamlit.streamlit.app](https://topsis-streamlit.streamlit.app)
...
- ✅ Numeric values in columns 2 onwards
- ✅ Equal count of weights, impacts, and data columns
- ✅ Valid impact values (+ or -)
- ✅ Valid email format (for web app)
...
## Author
**Naman Bansal** - Roll No: 102303496
